                ...
                for(Player p : getServer().getOnlinePlayers()) {
                    if(p.getGameMode().equals(GameMode.SURVIVAL) || p.getGameMode().equals(GameMode.ADVENTURE)){
                        ...
                        if (infected) {
                            ...
                            cfgm.savePlayerDB();
                            if(timer >= 120){
                                p.sendMessage("�8Votre infection a caus� votre perte....");
                                p.setHealth(0.0D);
                                ...
                                p.sendMessage("�8Votre infection est tr�s grave ! Cherchez vite une seringue !");
                                p.damage(3);
                ...
                for(Player p : getServer().getOnlinePlayers()) {
                    ...
                    if(p.getGameMode().equals(GameMode.SURVIVAL) || p.getGameMode().equals(GameMode.ADVENTURE))
                    {
                        ...
                        if (safezone > 0)
                        {
                            ...
                            {
                                p.sendTitle("", "�cIl vous reste "+safezone+" secondes d'invincibilit�");
                            }
                        }
                        else
                        {
                            if(safezone == 0)
                            {
                                p.sendMessage("�cVous n'�tes plus invincible !");
