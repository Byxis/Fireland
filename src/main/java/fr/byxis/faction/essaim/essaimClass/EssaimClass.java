...
public class EssaimClass
{
     ...
     * @throws EssaimConfigurationException
     *             if essaim info is not found
     */
     ...
     *            essaim name
     * @param _locationType
     *            type of location to load
     * @return Location object
     * @throws EssaimConfigurationException
     *             if location is not found
     */
    private Location loadRequiredLocation(EssaimConfigService _configService, String _name, EssaimConfigService.LocationType _locationType)
    {
        try
        {
        ...
        {
            throw new EssaimConfigurationException("Required location " + _locationType + " not configured for essaim " + _name, e);
        }
    }
     ...
     */
    private Location loadOptionalLocation(EssaimConfigService _configService, String _name, EssaimConfigService.LocationType _locationType)
    {
        try
        {
            return _configService.getEssaimLocation(_name, _locationType);
    ...
    {
        return "EssaimClass{" + "name='" + m_name + '\'' + ", formattedName='" + m_formattedName + '\'' + ", isFinished=" + isFinished()
                + ", isClosed=" + m_isClosed + ", isEventBased=" + isEventBased() + '}';
    }
