...
public class MenuEssaim
{
    ...
    private static void setItemEssaimMenu(Fireland main, Inventory inv, Player p)
    {
        ...
        setEssaimItem(main, inv, p, "station-de-traitement-des-eaux", Material.MOSSY_STONE_BRICKS, "§7Station de traitement des eaux", 12,
                4);
    ...
    private static void setEssaimItem(Fireland main, Inventory inv, Player p, String essaimName, Material material, String displayName,
            int slot, int difficulty)
    {
        ArrayList<String> lore = new ArrayList<>();
    ...
    private static void addRewardInformation(Fireland main, ArrayList<String> lore, Player p, String essaimName)
    {
        ...
        if (essaimInfo == null || essaimInfo.rewards() == null)
            return;
    ...
    private static String getRewardStatus(Fireland main, Player p, String essaimName, String rewardType, String rewardId,
