...
public class CustomStackSizeManager {
     ...
     * @param material Le matériau à modifier.
     * @param newMaxStackSize La nouvelle taille maximale du stack.
     */
     ...
     * @param material Le matériau de l'ItemStack.
     * @param amount La quantité initiale (sera ajustée si nécessaire).
     ...
     * @return La taille de stack personnalisée, ou la taille par défaut si non définie.
     */
