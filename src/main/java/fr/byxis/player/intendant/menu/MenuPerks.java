...
public class MenuPerks {
    ...
    private static void setPerksItems(Fireland main, Inventory inventory, Player p)
    {
        ...
        if (pInfos != null)
        {
            ...
            inventory.setItem(49, InventoryUtilities.setItemMetaLore(BlockUtilities.getGlassPaneColor(finfos.getColorcode()), finfos.getColorcode() + "Changer la couleur d'affichage de la faction", (short) 0, BasicUtilities.listMaker("§8Disponible seulement pour les personnes disposant ", "§8du grade Vétéran ou Stratège.", "§8Utilisable uniquement par le Leader.", "")));
