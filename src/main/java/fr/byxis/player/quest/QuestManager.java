...
public class QuestManager {
    ...
    public static void fillQuests(Player p)
    {
        ...
        if(main.cfgm.getPlayerDB().contains("quest."+p.getUniqueId()))
        {
            ...
            if(main.cfgm.getPlayerDB().contains("quest."+p.getUniqueId()+".1"))pq.setFirst(new ProgressQuest(main.cfgm.getPlayerDB().getInt("quest."+p.getUniqueId()+".1.id"), main.cfgm.getPlayerDB().getInt("quest."+p.getUniqueId()+".1.progress")));
            if(main.cfgm.getPlayerDB().contains("quest."+p.getUniqueId()+".2"))pq.setSecond(new ProgressQuest(main.cfgm.getPlayerDB().getInt("quest."+p.getUniqueId()+".2.id"), main.cfgm.getPlayerDB().getInt("quest."+p.getUniqueId()+".2.progress")));
            if(main.cfgm.getPlayerDB().contains("quest."+p.getUniqueId()+".3"))pq.setThird(new ProgressQuest(main.cfgm.getPlayerDB().getInt("quest."+p.getUniqueId()+".3.id"), main.cfgm.getPlayerDB().getInt("quest."+p.getUniqueId()+".3.progress")));
    ...
    public static void saveProgress()
    {
        ...
        for(PlayerQuests pq : playerQuest.values())
        {
            if(pq.getFirst() != null)
            {
                for(int i =1;  i<5; i++)
                {
                    main.cfgm.getPlayerDB().set("quest."+pq.getUuid()+"."+String.valueOf(i),null);
                    main.cfgm.getPlayerDB().set("quest."+pq.getUuid()+"."+String.valueOf(i)+".id",pq.getQuest(i).getId());
                    main.cfgm.getPlayerDB().set("quest."+pq.getUuid()+"."+String.valueOf(i)+".progress",pq.getQuest(i).getProgress());
                }
